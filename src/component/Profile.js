...
const Profile = () => {
    ...
    return (
        <div className='login text-white'>
            <div className='  2xl:containe py-5 h-[100vh]'>
                <div className='w-[40%] mx-auto grid grid-cols-1  h-[60vh]'>
                    <div className='flex flex-col justify-center items-center'>
                        <h2 className='sm:xl md:text-2xl lg:text-3xl font-bold'>Your Profile Information</h2>
                    </div>
